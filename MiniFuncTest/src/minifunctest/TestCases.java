...
public class TestCases {
	...
	static void arithmeticExpressioTest()
	{
		...
		*/
		...
		System.out.println(e2 + " * " + e3 + " = " + new MultiplyExpression(e2, e3).execute()); //DOUBLE DÖNDÜRÜYO İNTEGER OLACAK
		System.out.println(e2 + " / " + e5 + " = " + new DivisionExpression(e2, e5).execute()); //DOUBLE DÖNDÜRÜYO İNTEGER OLACAK
		System.out.println(e1 + " + (" + e2 + " / " + e5 + ") = " + new AddExpression(e1, new DivisionExpression(e2, e5)).execute());//DOUBLE DÖNDÜRÜYO İNTEGER OLACAK
	...
	static void conditionalExpression()
	{
		...
		*/
		...
		System.out.println(two + "*" + x1 + " " + equalOp + " " + x2 + " = " + new ConditionalExpression(new MultiplyExpression(two, x1), x2, equalOp).getValue());//BUNUN TRUE OLMASI LAZIM OUTPUT FALSE BASIYO
	}
	...
	static void ifExpression()
	{
		...
		*/
		...
		System.out.println(x2 + " = " + x2.getValue());
		// Here we know ConditionalExpression, NegateExpression and IfExpression are extended from Expression class
                // Also these three are instantiated so they are not abstract.
	...
	static void test999()
	{
		...
		*/
            Literal x = new IntegerLiteral(5);
	IntegerLiteral y= new IntegerLiteral(3);
            System.out.println(x + " + " + y + " = " + new AddExpression(x,y).execute());
